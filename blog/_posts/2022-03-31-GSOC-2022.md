...
* Contributors are invited to Google Summer of Code (GSoC) - 2022 !!!
  ...
  * The descriptions of these projects are as follows:
     ...
     * [VedicDateTime (Part A)](https://github.com/rstats-gsoc/gsoc2022/wiki/VedicDateTime-(Part-A)) (Co-mentor: Andrés E. Feijóo-Lorenzo).
     * [VedicDateTime (Part B)](https://github.com/rstats-gsoc/gsoc2022/wiki/VedicDateTime-(Part-B)) (Co-mentor: TBA).
