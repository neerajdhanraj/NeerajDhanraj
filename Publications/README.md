...
*  Goutam B., Hashmi M. F., Geem Z. W., and **Bokde N.** (2022). A Comprehensive Review of Deep Learning Strategies in Retinal Disease Diagnosis Using Fundus Images. _IEEE Access_ (IF 4.098). Accepted. DOI: [10.1109/ACCESS.2022.3178372](https://doi.org/10.1109/ACCESS.2022.3178372) `Review` `Deep Learning` `Computer Vision` `Object Detection` `Biomedical`
