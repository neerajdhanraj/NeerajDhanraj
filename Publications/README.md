...
* **Bokde N.**, Ali Z., Al-Hadidi M., Farooque A., Jamei M., Maliki A., Beyaztas B., Faris H., and Yaseen Z. (2021). Total Dissolved Salt Prediction Using Neurocomputing Models: Case Study of Gypsum Soil Within Iraq Region. _IEEE Access_ (IF 4.098). 9, 53617-53635.
* Gajghate P., Mirajkar A., Shaikh U., **Bokde N.**, Yaseen Z. (2021). Optimization of Layout and Pipe Sizes for Irrigation Pipe Distribution Network using Steiner point concept. _Mathematical Problems in Engineering_ (IF 1.305). vol. 2021, Article ID 6657459, 12 pages.
* Hashmi M. F., Ashish B. K., Sharma V., Keskar A. G., **Bokde N.**, Yoon J. H., and Geem Z. W. (2021). LARNet: Real-Time Detection of Facial Micro Expression Using Lossless Attention Residual Network. _Sensors_ (IF 3.576). 21(4), 1098.
* **Bokde N.**, Tranberg B., and Andresen G. B. (2021). Short-term CO2 emissions forecasting based on decomposition approaches and its impact on electricity market scheduling.
_Applied Energy_ (IF 9.746). 281, 116061. (Preprint: https://arxiv.org/pdf/2003.10868).
* Pandey P., **Bokde N.**, Dongre S., and Gupta R. (2021). Hybrid models for water demand forecasting. _Journal of Water Resources Planning and Management_ (IF 3.404). 147(2), 04020106.
* Ehteram M., Ferdowsi A., Faramarzpour M., Sami Al-Janabi M. A., Ansari N. A., **Bokde N.**, and Yaseen Z. M. (2021). Hybridization of artificial intelligence models with nature inspired optimization algorithms for lake water level prediction and uncertainty analysis. _Alexandria Engineering Journal_ (IF 3.732). 60(2), 2193-2208.

### 2020

* Gupta A., Pandey P., Feijoo A., Yaseen Z. M., and **Bokde N.** (2020). Smart Water Technology for Efficient Water Resource Management: A Review. _Energies_ (IF 3.004). 13(23), 6268.
* **Bokde N.**, Tranberg B., and Andresen G. B. (2020). A graphical approach to carbon-efficient spot market scheduling for Power-to-X applications. _Energy Conversion and Management_ (IF 9.709). 224, 113461. (Preprint: https://arxiv.org/abs/2009.03160).
* Shewale A., Mokhade A., Funde N., **Bokde N.** (2020). An Overview of Demand Response in Smart Grid and Optimization Techniques for Efficient Residential Appliance Scheduling
Problem. _Energies_ (IF 3.004). 13(16), 4266.
* Agenis-Nevers M., **Bokde N.**, Yaseen Z., and Shende M. (2020). An empirical estimation for time and memory algorithm complexities: Newly developed R package. _Multimedia Tools and Applications_ (IF 2.757). (https://doi.org/10.1007/s11042-020-09471-8)
* Hashmi M. F., Katiyar S., Keskar A. G., **Bokde N.**, and Geem Z. W. (2020). Efficient Pneumonia Detection in Chest Xray Images Using Deep Transfer Learning. _Diagnostics_ (IF 3.110), 10(6), 417.
* Hashmi M. F., Ashish B. K., Keskar A. G., **Bokde N.**, Yoon J. H., and Geem Z. W. (2020). An Exploratory Analysis on Visual Counterfeits using Conv-LSTM Hybrid Architecture. _IEEE Access_ (IF 4.098), 8, 101293-101308.
* **Bokde N.**, Yaseen Z. M. and Andresen G. B. (2020). ForecastTB - An R Package as a Test-bench for Time Series Forecasting: Application of Wind Speed and Solar Radiation
Modeling. _Energies_ (IF 3.004), 13(10), 2578.
* Hashmi M. F., Ashish B. K., Keskar A. G., **Bokde N.**, and Geem Z. W. (2020). FashionFit: Analysis of Mapping 3D Pose and Neural Body Fit for Custom Virtual Try-on. _IEEE Access_(IF 4.098), 8, 91603-91615.
* Murthy C. B., Hashmi M. F., **Bokde N.**, and Geem Z. W. (2020). Investigations of Object Detection in Images/Videos using Various Deep Learning Techniques and Embedded
Platforms – A Comprehensive Review. _Applied Sciences_ (IF 2.679), 10(9), 3280.
* Kannaiyan S., **Bokde N.**, and Geem Z. W. (2020). Solar Collectors Modeling and Controller Design for Solar Thermal Power Plant. _IEEE Access_ (IF 4.098), 8, 81425-81446.
* Gupta A., **Bokde N.**, Kulat K., and Yaseen Z. M. (2020). Nodal Matrix analysis for Optimal Pressure Reducing Valve Localization in Water Distribution System. _Energies_ (IF 3.004), 13(8), 1878.
* **Bokde N.**, Feijoo A., Al-Ansari N., Tao S., and Yaseen Z. M. (2020). The Hybridization of Ensemble Empirical Mode Decomposition with Forecasting Models: Application of
Short-Term Wind Speed and Power Modeling. _Energies_ (IF 3.004), 13(7), 1666.
* Rao A. Prabhakara, **Bokde N.**, and Sinha S. (2020). Photoacoustic Imaging for Management of Breast Cancer: A Literature Review and Future Perspectives. _Applied Sciences_ (IF 2.679), 10(3), 767.
