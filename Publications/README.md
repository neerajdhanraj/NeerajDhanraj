...
* **Bokde N.**, Milkevych V., Nielsen R., Villumsen T., and Sahana G. (2023). A Novel Approach for Anomaly Detection in Dairy Cow Gas Emission Records. _Computers and Electronics in Agriculture_ (IF 8.3). Accepted. DOI: [10.1016/j.compag.2023.108286](https://doi.org/10.1016/j.compag.2023.108286) `Methane emissions` `CO2 emissions` `Time series analysis` `Dairy cows`
