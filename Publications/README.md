...
* **Bokde N.**, Patil P., Sengupta S., Sawant M., and Feijoo A. (2023). VedicDateTime: An R Package to Implement Vedic Calendar System. _Multimedia Tools and Applications_ (IF 3.6). Accepted. DOI: []() `Software` `Vedic Calendar` `Time Series Analysis`
